...
import homeIcon from "../assets/img/categories/home.svg";
...
function CategoriesPage() {
   ...
   useEffect(() => {
      async function fetchCategories() {
         try {
            setIsLoading(true);
            const response = await axios.get(`https://d2778d56a9e0c274.mokky.dev/category/`)
         ...
         <div class="container">
            <div class="category-row">
                <Link to="/" class="category-item">
                    ...
                    <span class="category-item__title"> Рекомендации </span>
                 </Link>
                 {categories.map((category) => (
                  <Link to={`/test/page/${category.id}`} class="category-item">
