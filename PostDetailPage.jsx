...
function PostDetailPage() {
    ...
    useEffect(() => {
        async function fetchPost() {
            try {
                setIsLoading(true);
                const response = await axios.get(`https://d2778d56a9e0c274.mokky.dev/post/${id}`)
        ...
        {isLoading ? (<LoadingDetail />) :(
            ...
            <div class="post-detail-block">
                ...
                <p class="description">{post.description}</p>
                 ...
                 <span class="author"> Наши соц.сети <strong class="Light-success-text"> {post.author} </strong> </span>
